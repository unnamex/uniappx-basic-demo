!(function (e, t) {
  var n = e.document,
    ...
    o = (function () {
      ...
      return (
        (l.fn = l.prototype =
          {
            ...
            pushStack: function (e, t, n) {
              ...
              return (
                l.isArray(e) ? A.apply(r, e) : l.merge(r, e),
                (r.prevObject = this),
        ...
        l.extend({
          ...
          ready: function (e) {
            if ((!0 === e && !--l.readyWait) || (!0 !== e && !l.isReady)) {
              ...
              (a.fireWith(n, [l]), l.fn.trigger && l(n).trigger('ready').off('ready'));
            }
          },
          bindReady: function () {
            if (!a) {
          ...
          type: function (e) {
            return null == e ? String(e) : D[S.call(e)] || 'object';
          },
          ...
          parseJSON: function (t) {
            return 'string' == typeof t && t
              ? ((t = l.trim(t)),
                e.JSON && e.JSON.parse
                  ? e.JSON.parse(t)
                  : h.test(t.replace(m, '@').replace(g, ']').replace(y, ''))
          ...
          uaMatch: function (e) {
            e = e.toLowerCase();
            var t = v.exec(e) || b.exec(e) || x.exec(e) || (e.indexOf('compatible') < 0 && w.exec(e)) || [];
        ...
        (o = l.uaMatch(E)).browser && ((l.browser[o.browser] = !0), (l.browser.version = o.version)),
          ...
          u &&
            (e.once
              ? !0 === n
                ? p.disable()
                : (u = [])
              : c && c.length && ((n = c.shift()), p.fireWith(n[0], n[1]))));
      },
      p = {
        add: function () {
          if (u) {
  ...
  (o.extend({
    ...
    (o.support = (function () {
      ...
      if (
        ...
        return {};
      ((s = (a = n.createElement('select')).appendChild(n.createElement('option'))),
        (l = m.getElementsByTagName('input')[0]),
        (t = {
        ...
        (l.checked = !0),
        (t.noCloneChecked = l.cloneNode(!0).checked),
        (a.disabled = !0),
      ...
      if (
        ...
        ((l = n.createElement('input')).value = 't'),
        l.setAttribute('type', 'radio'),
        (t.radioValue = 't' === l.value),
        l.setAttribute('checked', 'checked'),
        m.appendChild(l),
        (c = n.createDocumentFragment()).appendChild(m.lastChild),
        ...
        e.getComputedStyle &&
          ...
          (t.reliableMarginRight =
            0 === (parseInt((e.getComputedStyle(u, null) || { marginRight: 0 }).marginRight, 10) || 0))),
        m.attachEvent)
      )
        for (p in { submit: 1, change: 1, focusin: 1 })
          ((h = (d = 'on' + p) in m) || (m.setAttribute(d, 'return;'), (h = 'function' == typeof m[d])),
            (t[p + 'Bubbles'] = h));
      return (
        c.removeChild(m),
        (c = a = s = u = m = l = null),
        o(function () {
          var e,
            ...
            c,
            d,
            p = n.getElementsByTagName('body')[0];
          p &&
            ...
            ((e = n.createElement('div')).style.cssText = u + 'width:0;height:0;position:static;top:0;margin-top:1px'),
            ...
            (t.reliableHiddenOffsets = h && 0 === f[0].offsetHeight),
            (m.innerHTML = ''),
            (m.style.width = m.style.paddingLeft = '1px'),
            (o.boxModel = t.boxModel = 2 === m.offsetWidth),
            void 0 !== m.style.zoom &&
              ((m.style.display = 'inline'),
              (m.style.zoom = 1),
              (t.inlineBlockNeedsLayout = 2 === m.offsetWidth),
              (m.style.display = ''),
              (m.innerHTML = "<div style='width:4px;'></div>"),
              (t.shrinkWrapBlocks = 2 !== m.offsetWidth)),
            (m.style.cssText = l + u),
            (m.innerHTML = d),
            (i = (r = m.firstChild).firstChild),
            (a = r.nextSibling.firstChild.firstChild),
            (s = { doesNotAddBorder: 5 !== i.offsetTop, doesAddBorderForTableAndCells: 5 === a.offsetTop }),
            ...
            (s.doesNotIncludeMarginInBodyOffset = 1 !== p.offsetTop),
            p.removeChild(e),
            (m = e = null),
            o.extend(t, s));
        }),
    ...
    data: function (e, n, r, i) {
      if (o.acceptData(e)) {
        var a,
          ...
          p = f ? e[u] : e[u] && u,
          h = 'events' === n;
        if ((p && d[p] && (h || i || d[p].data)) || !c || r !== t)
          return (
            p || (f ? (e[u] = p = ++o.uuid) : (p = u)),
            d[p] || ((d[p] = {}), f || (d[p].toJSON = o.noop)),
            ('object' != typeof n && 'function' != typeof n) ||
              (i ? (d[p] = o.extend(d[p], n)) : (d[p].data = o.extend(d[p].data, n))),
            (a = s = d[p]),
            i || (s.data || (s.data = {}), (s = s.data)),
            r !== t && (s[o.camelCase(n)] = r),
            h && !s[n] ? a.events : (c ? null == (l = s[n]) && (l = s[o.camelCase(n)]) : (l = s), l)
          );
      }
    },
    removeData: function (e, t, n) {
      if (o.acceptData(e)) {
        ...
        if (u[c]) {
          ...
          (n || (delete u[c].data, f(u[c]))) &&
            (o.support.deleteExpando || !u.setInterval ? delete u[c] : (u[c] = null),
            l && (o.support.deleteExpando ? delete e[s] : e.removeAttribute ? e.removeAttribute(s) : (e[s] = null)));
        }
      }
    },
    ...
    o.extend({
      ...
      attr: function (e, n, r, i) {
        var a,
          ...
          u = e.nodeType;
        if (e && 3 !== u && 8 !== u && 2 !== u)
          return i && n in o.attrFn
            ? o(e)[n](r)
            : void 0 === e.getAttribute
              ? o.prop(e, n, r)
              : ((l = 1 !== u || !o.isXMLDoc(e)) &&
                  ((n = n.toLowerCase()), (s = o.attrHooks[n] || (T.test(n) ? h : p))),
                r !== t
                  ? null === r
                    ? void o.removeAttr(e, n)
      ...
      removeAttr: function (e, t) {
        var n,
          ...
          s = 0;
        if (t && 1 === e.nodeType)
          for (a = (r = t.toLowerCase().split(y)).length; s < a; s++)
            (i = r[s]) &&
              ((n = o.propFix[i] || i),
              o.attr(e, i, ''),
  ...
  var C = /^(?:textarea|input|select)$/i,
    ...
    D = function (e) {
      return o.event.special.hover ? e : e.replace(S, 'mouseenter$1 mouseleave$1');
    };
  function M() {
    return !1;
  }
  ...
  ((o.event = {
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (v && (p = v.events)) {
        for (t = o.trim(D(t || '')).split(' '), a = 0; a < t.length; a++)
          if (((l = u = (s = E.exec(t[a]) || [])[1]), (c = s[2]), l)) {
            for (
              h = o.event.special[l] || {},
                f = (g = p[(l = (r ? h.delegateType : h.bindType) || l)] || []).length,
              ...
              ((y = g[d]),
                (!i && u !== y.origType) ||
                  ...
                  (g.splice(d--, 1), y.selector && g.delegateCount--, h.remove && h.remove.call(e, y)));
            0 === g.length &&
              f !== g.length &&
              ((h.teardown && !1 !== h.teardown.call(e, c)) || o.removeEvent(e, l, v.handle), delete p[l]);
          } else for (l in p) o.event.remove(e, l + t[a], n, r, !0);
        o.isEmptyObject(p) && ((m = v.handle) && (m.elem = null), o.removeData(e, ['events', 'handle'], !0));
      }
    },
          ...
          if (
            ...
            if (
              ...
              if (((m = [[i, p.bindType || y]]), !a && !p.noBubble && !o.isWindow(i))) {
                for (g = p.delegateType || y, c = j.test(g + y) ? i : i.parentNode, f = null; c; c = c.parentNode)
                  (m.push([c, g]), (f = c));
              ...
              for (u = 0; u < m.length && !n.isPropagationStopped(); u++)
                ((c = m[u][0]),
                  ...
                  (h = d && c[d]) && o.acceptData(c) && !1 === h.apply(c, r) && n.preventDefault());
              return (
                (n.type = y),
                a ||
    ...
    dispatch: function (n) {
      ...
      var r,
        ...
        m,
        g,
        y = (o._data(this, 'events') || {})[n.type] || [],
        v = y.delegateCount,
        b = [].slice.call(arguments, 0),
        x = !n.exclusive && !n.namespace,
        w = [];
      if (((b[0] = n), (n.delegateTarget = this), v && !n.target.disabled && (!n.button || 'click' !== n.type)))
        for ((s = o(this)).context = this.ownerDocument || this, a = n.target; a != this; a = a.parentNode || this) {
          for (u = {}, f = [], s[0] = a, r = 0; r < v; r++)
            (u[(p = (d = y[r]).selector)] === t &&
              (u[p] = d.quick
                ? ((h = a),
                  (m = d.quick),
                  (g = void 0),
                  (g = h.attributes || {}),
                  (!m[1] || h.nodeName.toLowerCase() === m[1]) &&
                    (!m[2] || (g.id || {}).value === m[2]) &&
                    (!m[3] || m[3].test((g.class || {}).value)))
                : s.is(p)),
              u[p] && f.push(d));
          f.length && w.push({ elem: a, matches: f });
        }
      for (
        y.length > v && w.push({ elem: this, matches: y.slice(v) }), r = 0;
        r < w.length && !n.isPropagationStopped();
        r++
      )
        for (c = w[r], n.currentTarget = c.elem, i = 0; i < c.matches.length && !n.isImmediatePropagationStopped(); i++)
          ((d = c.matches[i]),
            (x || (!n.namespace && !d.namespace) || (n.namespace_re && n.namespace_re.test(d.namespace))) &&
              ((n.data = d.data),
              (n.handleObj = d),
              (l = ((o.event.special[d.origType] || {}).handle || d.handler).apply(c.elem, b)) !== t &&
                ((n.result = l), !1 === l && (n.preventDefault(), n.stopPropagation()))));
      return n.result;
    },
    props:
    ...
    o.fn.extend({
      ...
      off: function (e, n, r) {
        if (e && e.preventDefault && e.handleObj) {
          var i = e.handleObj;
          return (
            o(e.delegateTarget).off(i.namespace ? i.type + '.' + i.namespace : i.type, i.selector, i.handler),
            this
          );
        }
        if ('object' == typeof e) {
    ...
    o.each(
      ...
      function (e, t) {
        ((o.fn[t] = function (e, n) {
          ...
          k.test(t) && (o.event.fixHooks[t] = o.event.keyHooks),
  ...
  function $(e, t, n) {
    ...
    if ('string' == typeof t) {
      ...
      if (B.test(t)) return o.filter(t, r, !n);
      t = o.filter(t, r);
    }
    return o.grep(e, function (e, r) {
      ...
      function (e, t) {
        o.fn[e] = function (n, r) {
          ...
          return (
            ...
            (this.length > 1 || P.test(r)) && H.test(e) && (i = i.reverse()),
  ...
  function te(e, t) {
    (t.src
      ...
      : o.globalEval((t.text || t.textContent || t.innerHTML || '').replace(Z, '/*$0*/')),
  ...
  ((ee.optgroup = ee.option),
    ...
    o.fn.extend({
      ...
      html: function (e) {
        if (e === t) return this[0] && 1 === this[0].nodeType ? this[0].innerHTML.replace(z, '') : null;
        if (
          'string' != typeof e ||
          J.test(e) ||
          (!o.support.leadingWhitespace && V.test(e)) ||
          ee[(G.exec(e) || ['', ''])[1].toLowerCase()]
        )
          o.isFunction(e)
            ? this.each(function (t) {
                var n = o(this);
      ...
      domManip: function (e, n, r) {
        var i,
          ...
          c = e[0],
          f = [];
        if (!o.support.checkClone && 3 === arguments.length && 'string' == typeof c && K.test(c))
          return this.each(function () {
        ...
        if (o.isFunction(c))
          return this.each(function (i) {
            var a = o(this);
            ((e[0] = c.call(this, i, n ? a.html() : t)), a.domManip(e, n, r));
          });
        if (this[0]) {
          if (
            ((l = c && c.parentNode),
            (a =
              ...
              (s = (i =
                o.support.parentNode && l && 11 === l.nodeType && l.childNodes.length === this.length
                  ? { fragment: l }
                  : o.buildFragment(e, this, f)).fragment).childNodes.length
                ? (s = s.firstChild)
                : s.firstChild))
          ) {
            n = n && o.nodeName(a, 'tr');
            for (var d = 0, p = this.length, h = p - 1; d < p; d++)
              r.call(
                n
                  ? ((u = this[d]),
                    a,
                    o.nodeName(u, 'table')
                      ...
                      : u)
                  : this[d],
                i.cacheable || (p > 1 && d < h) ? o.clone(s, !0, !0) : s,
              );
          }
          f.length && o.each(f, te);
        }
        return this;
      },
    }),
    (o.buildFragment = function (e, t, r) {
      ...
      return (
        (l = n),
        !(1 === e.length && 'string' == typeof u && u.length < 512 && l === n && '<' === u.charAt(0)) ||
          Q.test(u) ||
          (!o.support.checkClone && K.test(u)) ||
          (!o.support.html5Clone && Y.test(u)) ||
  ...
  function he(e, t, n) {
    ...
    if (r > 0) {
      if ('border' !== n)
        for (; a < s; a++)
          (n || (r -= parseFloat(o.css(e, 'padding' + i[a])) || 0),
            'margin' === n
              ? (r += parseFloat(o.css(e, n + i[a])) || 0)
              : (r -= parseFloat(o.css(e, 'border' + i[a] + 'Width')) || 0));
      return r + 'px';
    }
    if ((((r = ne(e, t, t)) < 0 || null == r) && (r = e.style[t] || 0), (r = parseFloat(r) || 0), n))
      for (; a < s; a++)
        ((r += parseFloat(o.css(e, 'padding' + i[a])) || 0),
          'padding' !== n && (r += parseFloat(o.css(e, 'border' + i[a] + 'Width')) || 0),
          'margin' === n && (r += parseFloat(o.css(e, n + i[a])) || 0));
    return r + 'px';
  }
  ((o.fn.css = function (e, n) {
    ...
    o.extend({
      ...
      css: function (e, n, r) {
        ...
        return (
          ...
          a && 'get' in a && (i = a.get(e, !0, r)) !== t ? i : ne ? ne(e, n) : void 0
        );
      },
      swap: function (e, t, n) {
        var r = {};
    ...
    o.support.opacity ||
      (o.cssHooks.opacity = {
        get: function (e, t) {
          return ae.test((t && e.currentStyle ? e.currentStyle.filter : e.style.filter) || '')
        ...
        set: function (e, t) {
          ...
          ((n.zoom = 1),
            (t >= 1 && '' === o.trim(a.replace(oe, '')) && (n.removeAttribute('filter'), r && !r.filter)) ||
              (n.filter = oe.test(a) ? a.replace(oe, i) : a + ' ' + i));
        },
      }),
    o(function () {
  ...
  try {
    ...
    (((me = n.createElement('a')).href = ''), (me = me.href));
  }
  function _e(e) {
    return function (t, n) {
      if (('string' != typeof t && ((n = t), (t = '*')), o.isFunction(n)))
        for (var r, i, a = t.toLowerCase().split(Ae), s = 0, l = a.length; s < l; s++)
          ((r = a[s]), (i = /^\+/.test(r)) && (r = r.substr(1) || '*'), (e[r] = e[r] || [])[i ? 'unshift' : 'push'](n));
    };
  }
  function He(e, n, r, i, o, a) {
    (a = a || {})[(o = o || n.dataTypes[0])] = !0;
    for (var s, l = e[o], u = 0, c = l ? l.length : 0, f = e === De; u < c && (f || !s); u++)
      'string' == typeof (s = l[u](n, r, i)) &&
        (!f || a[s] ? (s = t) : (n.dataTypes.unshift(s), (s = He(e, n, r, i, s, a))));
    return ((!f && s) || a['*'] || (s = He(e, n, r, i, '*', a)), s);
  }
  function Pe(e, n) {
    var r,
      i,
  ...
  function Be(e, t, n, r) {
    if (o.isArray(t))
      o.each(t, function (t, i) {
        n || ve.test(e) ? r(e, i) : Be(e + '[' + ('object' == typeof i || o.isArray(i) ? t : '') + ']', i, n, r);
      });
    else if (n || null == t || 'object' != typeof t) r(e, t);
    else for (var i in t) Be(e + '[' + i + ']', t[i], n, r);
  }
  ((ge = Fe.exec(me.toLowerCase()) || []),
    o.fn.extend({
      load: function (e, n, r) {
        if ('string' != typeof e && Le) return Le.apply(this, arguments);
            ...
            complete: function (e, t, n) {
              ((n = e.responseText),
                e.isResolved() &&
                  ...
                  l.html(a ? o('<div>').append(n.replace(Se, '')).find(a) : n)),
                r && l.each(r, [n, t, e]));
            },
          }),
          this
      ...
      serializeArray: function () {
        return this.map(function () {
          ...
          .filter(function () {
            return this.name && !this.disabled && (this.checked || ke.test(this.nodeName) || Te.test(this.type));
          })
          .map(function (e, t) {
            var n = o(this).val();
            return null == n
    ...
    o.extend({
      ...
      ajaxSetup: function (e, t) {
        return (t ? Pe(e, o.ajaxSettings) : ((t = e), (e = o.ajaxSettings)), Pe(e, t), e);
      },
      ajaxSettings: {
        url: me,
      ...
      ajax: function (e, n) {
        ...
        if (
          ...
          (d.url = ((e || d.url) + '').replace(xe, '').replace(Ce, ge[1] + '//')),
          (d.dataTypes = o
            .trim(d.dataType || '*')
            .toLowerCase()
            .split(Ae)),
          null == d.crossDomain &&
            ((u = Fe.exec(d.url.toLowerCase())),
            (d.crossDomain = !(
              !u ||
              (u[1] == ge[1] &&
                u[2] == ge[2] &&
                (u[3] || ('http:' === u[1] ? 80 : 443)) == (ge[3] || ('http:' === ge[1] ? 80 : 443)))
            ))),
        ...
        if (
          ...
          !d.hasContent &&
            (d.data && ((d.url += (Ee.test(d.url) ? '&' : '?') + d.data), delete d.data), (r = d.url), !1 === d.cache))
        ) {
          var N = o.now(),
            C = d.url.replace(je, '$1_=' + N);
          d.url = C + (C === d.url ? (Ee.test(d.url) ? '&' : '?') + '_=' + N : '');
        }
        ...
        w.setRequestHeader(
          ...
          d.dataTypes[0] && d.accepts[d.dataTypes[0]]
            ? d.accepts[d.dataTypes[0]] + ('*' !== d.dataTypes[0] ? ', ' + Oe + '; q=0.01' : '')
            : d.accepts['*'],
        ),
        d.headers))
      ...
      param: function (e, n) {
        ...
        else for (var a in e) Be(a, e[a], n, i);
      ...
      if ('jsonp' === t.dataTypes[0] || (!1 !== t.jsonp && (We.test(t.url) || (i && We.test(t.data))))) {
        ...
        return (
          !1 !== t.jsonp &&
            ((u = u.replace(We, f)),
            t.url === u &&
              (i && (c = c.replace(We, f)), t.data === c && (u += (/\?/.test(u) ? '&' : '?') + t.jsonp + '=' + s))),
          (t.url = u),
          (t.data = c),
          (e[s] = function (e) {
            a = [e];
  ...
  ((o.ajaxSettings.xhr = e.ActiveXObject
    ...
    : ze),
    (Re = o.ajaxSettings.xhr()),
    o.extend(o.support, { ajax: !!Re, cors: !!Re && 'withCredentials' in Re }),
    o.support.ajax &&
            ...
            send: function (i, a) {
              ...
              (u.send((n.hasContent && n.data) || null),
                (r = function (e, i) {
                  ...
                  try {
                    if (r && (i || 4 === u.readyState))
                      if (((r = t), s && ((u.onreadystatechange = o.noop), $e && delete Ie[s]), i))
                ...
                n.async && 4 !== u.readyState
                  ? ((s = ++Xe), $e && (Ie || ((Ie = {}), o(e).unload($e)), (Ie[s] = r)), (u.onreadystatechange = r))
                  : r());
            },
            abort: function () {
              r && r(0, 1);
  ...
  function et() {
    return (setTimeout(tt, 0), (Je = o.now()));
  }
  function tt() {
    Je = t;
  }
  function nt(e, t) {
    var n = {};
    return (
      o.each(Ze.concat.apply([], Ze.slice(0, t)), function () {
        n[this] = e;
      }),
      n
    );
  ...
  function rt(e) {
    if (!Qe[e]) {
      ...
      (r.remove(),
        ('none' !== i && '' !== i) ||
          (Ve || ((Ve = n.createElement('iframe')).frameBorder = Ve.width = Ve.height = 0),
          t.appendChild(Ve),
          (Ue && Ve.createElement) ||
            ((Ue = (Ve.contentWindow || Ve.contentDocument).document).write(
              ('CSS1Compat' === n.compatMode ? '<!doctype html>' : '') + '<html><body>',
            ),
            Ue.close()),
          (r = Ue.createElement(e)),
          Ue.body.appendChild(r),
          (i = o.css(r, 'display')),
          t.removeChild(Ve)),
        (Qe[e] = i));
    }
    ...
    show: function (e, t, n) {
      ...
      for (var a = 0, s = this.length; a < s; a++)
        (r = this[a]).style &&
          ...
          '' === i && 'none' === o.css(r, 'display') && o._data(r, 'olddisplay', rt(r.nodeName)));
      for (a = 0; a < s; a++)
        (r = this[a]).style &&
      ...
      return (
        o.isFunction(e) && o.isFunction(t)
          ...
          : null == e || r
            ...
            : this.animate(nt('toggle', 3), e, t, n),
        this
      );
    },
        ...
        for (r in ((d.animatedProperties = {}), e)) {
          ...
          !p ||
            ...
            'inline' === o.css(this, 'display') &&
              ...
              (o.support.inlineBlockNeedsLayout && 'inline' !== rt(this.nodeName)
                ? (this.style.zoom = 1)
    ...
    (o.fx.prototype = {
      ...
      custom: function (e, n, r) {
        ...
        ((this.startTime = Je || et()),
          ...
          s() && o.timers.push(s) && !Ge && (Ge = setInterval(a.tick, a.interval)));
      },
      show: function () {
          ...
          ((n = l ? l.getComputedStyle(t, null) : t.currentStyle),
            ...
            t === r &&
              ...
              !o.support.doesNotAddBorder ||
                (o.support.doesAddBorderForTableAndCells && it.test(t.nodeName)) ||
    ...
    o.fn.extend({
      position: function () {
        ...
        var e = this[0],
          t = this.offsetParent(),
          n = this.offset(),
          r = ot.test(t[0].nodeName) ? { top: 0, left: 0 } : t.offset();
        return (
      ...
      o.fn[r] = function (n) {
        ...
        return n === t
          ? (i = this[0])
            ...
            : null
          : this.each(function () {
              (a = at(this)) ? a.scrollTo(e ? o(a).scrollLeft() : n, e ? n : o(a).scrollTop()) : (this[r] = n);
            });
      };
    }),
